...
Route::middleware('setLanguage')->group(function () {
    Route::get('/', [Web\WebController::class, 'index'])->name('main');
    // Routes for Enquiry Form
    Route::get('/home-page', [Web\WebController::class, 'home'])->name('front');
    ...
    Route::get('/docs', [Web\WebController::class, 'docs'])->name('docs');
    Route::get('/releases', [Web\WebController::class, 'releases'])->name('releases');
    // Routes for Qr code
