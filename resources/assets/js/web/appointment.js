...
function loadWebAppointmentDate () {
    ...
    $('#customFieldSelect').selectize();
    $('#customFieldMultiSelect').selectize();
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.data != null) {
                        ...
                        displayErrorMessage(
                            Lang.get('js.patient_not_exists_or_status_is_not_active'))
                    }
                },
            })
        }
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            displaySuccessMessage(
                ...
                Lang.get('js.saved_successfully'))
