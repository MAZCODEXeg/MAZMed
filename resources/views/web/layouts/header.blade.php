    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-1 col-4">
                <a href="{{ url('/home-page') }}" class="header-logo">
                    <img src="{{asset(getLogoUrl()) }}" alt="MAZMed" class="img-fluid" />
                </a>
            </div>
                ...
                <nav class="navbar navbar-expand-xl navbar-light justify-content-end py-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul class="navbar-nav align-items-center py-2 py-lg-0">
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('/home-page') ? 'active' : '' }}" aria-current="page" href="{{ url('/home-page') }}">
